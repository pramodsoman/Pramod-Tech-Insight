const apiKey = "_5GGpkyYpOTUIuCvcEnsU8SK24GsqMfqUPzaxEmgY07lp4gK";
let page = 1;
let totalResults = 0;
...
async function getFullStackNews() {
  const fullStackApiUrl = `https://api.currentsapi.services/v1/search?&apiKey=${apiKey}&category=programming&language=en&page=${page}`;
